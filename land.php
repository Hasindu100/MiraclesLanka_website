...
<body>
  ...
  <div class="row">
    ...
    <div class="container-6">
            ...
            <?php
                include 'config.php';
                $query = $db->query("SELECT * FROM land ORDER BY land.uploaded_on DESC");
                if($query->num_rows > 0){
                    while($row = $query->fetch_assoc()){
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card-body">
                                <h4 class="card-title" style="color:#D35400">RS. '.$row["price"].' <b style="font-size:20px;color:gray">per perch</b> </h4> 
                                <p class="card-text">'.$s.'....</p>
                                <a href="landinfo.php?land_id='.$row["land_id"].'" class="btn btn-success">View more>></a>
                            </div>
                        </div>
                    </div>';
                    echo $output;
