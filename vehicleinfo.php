...
<head>
   ...
   <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
    ...
    <title>Mirakels Life International</title>
            ...
            <div class="col-md-12">
                <div class="card mb-2">
                    ...
                    <?php
                        ...
                        $query2 = $db->query("SELECT * FROM images WHERE cat_id = '$vehicle_id' ORDER BY uploaded_on DESC");
                        if($query2->num_rows > 0){
                            while($row2 = $query2->fetch_assoc()){
                                $imageURL2 = 'uploads/'.$row2["file_name"];
                                $output2 = '<img class="mySlides" src="'.$imageURL2.'" style="width:100%">';
                                echo $output2;
                            }
                        }
                        ...
                        echo $output;
                        $query = $db->query("SELECT * FROM vehicle WHERE vehicle_id = '$vehicle_id'");
                        if($query->num_rows > 0){
                            while($row = $query->fetch_assoc()){
                                $output3 = '<div class="card-body">
                                <h4 class="card-title" style="color:black">'.$row["title"].'</h4><hr>
                                <h5 class="card-title" style="color:#bbb">'.$row["location"].'</h5>
                                <h4 class="card-title" style="color:green">RS.'.$row["price"].'</h4>
                                <h5>Brand: <span class="details">'.$row["brand"].'</span></h5>
                                <h5>Model: <span class="details">'.$row["model"].'</span></h5>
                                <h5>Edition: <span class="details">'.$row["edition"].'</span></h5>
                                <h5>Transmission: <span class="details">'.$row["transmission"].'</span></h5>
                                <h5>Fuel Type: <span class="details">'.$row["fuel"].'</h5>
                                <h5>Engine Capacity: <span class="details">'.$row["capacity"].'cc</span></h5>
                                <h5 style="font-weight:bold">Description: <span class="details">'.$row["description"].'</span></h5>
