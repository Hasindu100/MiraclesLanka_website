...
<body>
    <nav>
        <div class="logo"><img src ="images/123880284_102022315057554_6400407058210913611_o copy.png" >Mirakels Life</div>
        ...
        <ul>
            ...
            <li><a href="#login" data-toggle="modal" data-target="#exampleModalCenter-2">Login</a></li>
        </ul>
    </nav>
  ...
  <div class="row">
    ...
    <div class="col-sm-6" style="background-color:lavenderblush;">
            ...
            <?php
                ...
                $query = $db->query("SELECT * FROM services WHERE cat_id='$service_id'");
                if($query->num_rows > 0){
    ...
    <div class="col-sm-3" style="background-color:lavender;">.col-sm-3dsfd</div>
  </div>
</div>
